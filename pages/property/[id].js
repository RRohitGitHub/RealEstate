...
const PropertyDetails = ({propertyDetails:{price,rentFrequency,rooms,title,bath,area,agency,isVerified,description,type,purpose,furnishingStatus,amenities,photos}})=>{
